    ...
    <div className="py-10 px-4">
      <div className="flex items-center space-x-3">
        ...
        <div className="flex flex-col">
          ...
          <span className="text-sm font-medium text-gray-500">Edit profile &rarr;</span>
        </div>
      </div>
      <div className="mt-10 flex justify-around ">
        <div className="flex cursor-pointer flex-col items-center">
          ...
          <span className="mt-2 text-sm font-medium text-gray-500">판매내역</span>
        </div>
        <div className="flex cursor-pointer flex-col items-center">
          <div className="flex h-14 w-14 items-center justify-center rounded-full bg-orange-500 text-white hover:bg-orange-600">
            <svg
          ...
          <span className="mt-2 text-sm font-medium text-gray-500">구매내역</span>
        </div>
        <div className="flex cursor-pointer flex-col items-center">
          <div className="flex h-14 w-14 items-center justify-center rounded-full bg-orange-500 text-white hover:bg-orange-600">
            <svg
          ...
          <span className="mt-2 text-sm font-medium text-gray-500">관심목록</span>
        </div>
      </div>
      <div className="mt-12">
